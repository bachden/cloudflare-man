const healthy = new Set(["active", "healthy", "verified", "installed", "enabled", "ready", "completed", "success", "connected", "waiting_for_new_enrollment"]);
...
export function StatusBadge({ status }: { status: string }) {
  ...
  const label = status === "staled_ignored" ? "staled - ignored" : status === "waiting_for_new_enrollment" ? "waiting for new enrollment" : status.replaceAll("_", " ");
