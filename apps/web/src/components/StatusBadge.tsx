const healthy = new Set(["active", "healthy", "verified", "installed", "enabled", "ready", "completed"]);
const warning = new Set(["url_issued", "claimed", "provisioning", "connector_online", "inactive", "pending", "running", "unenroll_pending", "unenroll_failed", "unverified", "degraded"]);
